                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="area_coverage" value="<?= $acc['area_coverage'] ?>" name="area_coverage" class="form-control"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date_started" name="date_started" value="<?= $acc['date_started'] ?>" class="form-control mydatepicker" readonly placeholder="mm/dd/yyyy"></div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="control-label">Due Date</label>
                                            <input type="text" id="due_date" name="due_date" value="<?= $acc['due_date'] ?>" class="form-control mydatepicker" placeholder="mm/dd/yyyy"></div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['monthly']=='1000' && $acc['subs_option']=='1' ? 'checked' : null ?> value="1000" id="m-1" name="monthly">
                                            <label for="m-1">1000</label><br>
                                            <input type="radio" <?= $acc['monthly']=='1500' && $acc['subs_option']=='1' ? 'checked' : null ?> value="1500" id="m-2" name="monthly">
                                            <label for="m-2">1500</label><br>
                                            <input type="radio" <?= $acc['monthly']=='2000' && $acc['subs_option']=='1' ? 'checked' : null ?> value="2000" id="m-3" name="monthly">
                                            <label for="m-3">2000</label><br>
                                            <input type="radio" <?= $acc['monthly']=='3000' && $acc['subs_option']=='1' ? 'checked' : null ?> value="3000" id="m-4" name="monthly">
                                            <label for="m-4">3000</label><br>
                                            
                                            <?php if($acc['monthly']!='1000' && $acc['monthly']!='1500' && $acc['monthly']!='2000' && $acc['monthly']!='3000' && $acc['subs_option']=='1'): ?>
                                                <input type="radio" value="other" checked id="m-5" name="monthly">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['device_user']=='multiple' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="multiple" id="device" name="device_user" data-radio="iradio_square-blue">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['b_affiliates']=='yes' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="yes" id="yes" name="business_aff" data-radio="iradio_square-blue">
                                            <label for="yes">Yes</label><br>
                                            <input type="radio" <?= $acc['b_affiliates']=='no' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="no" id="no" name="business_aff" data-radio="iradio_square-blue">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['speed']=='10mbps' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="10mbps" id="speed-1" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-1">Up to 10mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='15mbps' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="15mbps" id="speed-2" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-2">15mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='20mbps' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="20mbps" id="speed-3" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-3">20mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='30mbps' && $acc['subs_option']=='1' ? 'checked' : null ?> class="check" value="30mbps" id="speed-4" name="speed" data-radio="iradio_square-blue">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <label>Monthly Subscription</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['monthly']=='1500' && $acc['subs_option']=='2' ? 'checked' : null ?> value="1000" id="mp-1" name="monthly">
                                            <label for="mp-1">1500</label><br>
                                            <input type="radio" <?= $acc['monthly']=='2500' && $acc['subs_option']=='2' ? 'checked' : null ?> value="2500" id="mp-2" name="monthly">
                                            <label for="mp-2">2500</label><br>
                                            <input type="radio" <?= $acc['monthly']=='3500' && $acc['subs_option']=='2' ? 'checked' : null ?> value="3500" id="mp-3" name="monthly">
                                            <label for="mp-3">3500</label><br>

                                            <?php if($acc['monthly']!='1500' && $acc['monthly']!='2500' && $acc['monthly']!='3500' && $acc['subs_option']=='2'): ?>
                                                <input type="radio" value="other1" checked id="mp-5" name="monthly">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <label>Device User</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['device_user']=='multiple' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="multiple" id="device" name="device_user" data-radio="iradio_square-blue">
                                            <label for="device">multiple</label><br>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <label>Business Affiliates</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['b_affiliates']=='yes' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="yes" id="yes" name="business_aff" data-radio="iradio_square-blue">
                                            <label for="yes">Yes</label><br>
                                            <input type="radio" <?= $acc['b_affiliates']=='no' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="no" id="no" name="business_aff" data-radio="iradio_square-blue">
                                            <label for="no">No</label><br>
                                            <label><small><i>If Yes, add 2800 for antenna. Profit share in 20%.</i></small></label>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <label>DL & UL Speed</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['speed']=='10mbps' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="10mbps" id="speed-1" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-1">Up to 10mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='15mbps' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="15mbps" id="speed-2" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-2">15mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='20mbps' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="20mbps" id="speed-3" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-3">20mbps</label><br>
                                            <input type="radio" <?= $acc['speed']=='30mbps' && $acc['subs_option']=='2' ? 'checked' : null ?> class="check" value="30mbps" id="speed-4" name="speed" data-radio="iradio_square-blue">
                                            <label for="speed-4">30mbps</label><br>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <label>Monthly Subscription</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['monthly']=='300' && $acc['subs_option']=='3' ? 'checked' : null ?> value="300" id="ml-1" name="monthly">
                                            <label for="ml-1">300</label><br>

                                            <?php if($acc['monthly']!='300' && $acc['subs_option']=='3'): ?>
                                                <input type="radio" value="other2" checked id="ml-5" name="monthly">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <label>Device User</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['device_user']=='per device' && $acc['subs_option']=='3' ? 'checked' : null ?> class="check" value="per device" id="device" name="device_user" data-radio="iradio_square-blue">
                                    ...
                                    <div class="col-md-2 col-sm-6">
                                        <label>Business Affiliates</label>
                                        <div class="form-group">
                                            <input type="radio" <?= $acc['b_affiliates']=='yes' && $acc['subs_option']=='3' ? 'checked' : null ?> class="check" value="yes" id="yes" name="business_aff" data-radio="iradio_square-blue">
                                            <label for="yes">Yes</label><br>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-sm-6">
                                        <label>DL & UL Speed</label>
                                        <div class="form-group">
                                            <input type="radio"  <?= $acc['speed']=='3mbps' && $acc['subs_option']=='3' ? 'checked' : null ?> class="check" value="3mbps" id="speed-1" name="speed" data-radio="iradio_square-blue">
