...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= site_url() ?>assets/plugins/images/favicon.png">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?= previous_url() ?>" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Go Back</a> </div>
            <footer class="footer text-center"><?= date('Y') ?> © Subscribers Management System.</footer>
        </div>
    </section>
    <!-- ===== jQuery ===== -->
